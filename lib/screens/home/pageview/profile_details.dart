...
import 'package:delivery_dee/screens/home/subview/algorand_setup.dart';
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ListTile(
                                ...
                                leading: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child:
                                        _appController.cardPaymentMethod.value
                                            ? Icon(
                                                Icons.check,
                                                size: 30.0,
                                                color: Colors.white,
                              ...
                              ListTile(
                                ...
                                leading: Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(10.0),
                                    child:
                                        _appController.bankPaymentMethod.value
                                            ? Icon(
                                                Icons.check,
                                                size: 30.0,
                                                color: Colors.white,
                              ...
                              ListTile(
                                ...
                                leading: Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(10.0),
                                    child:
                                        _appController.cashPaymentMethod.value
                                            ? Icon(
                                                Icons.check,
                                                size: 30.0,
                                                color: Colors.white,
                              ...
                              ListTile(
                                onTap: () =>
                                    _appController.changeToAlgoPaymentMethod(),
                                leading: Container(
                                  decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      color: Colors.blue),
                                  child: Padding(
                                    padding: const EdgeInsets.all(10.0),
                                    child:
                                        _appController.algoPaymentMethod.value
                                            ? Icon(
                                                Icons.check,
                                                size: 30.0,
                                                color: Colors.white,
                                ...
                                trailing: userController
                                        .userData.value.publicAddress.isEmpty
                                    ? IconButton(
                                        onPressed: () {
